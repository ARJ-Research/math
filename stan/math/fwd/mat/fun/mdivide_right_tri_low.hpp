...
inline Eigen::Matrix<fvar<T>, R1, C1> mdivide_right_tri_low(
  ...
  Eigen::Matrix<T, R2, C2> val_b(Eigen::Matrix<T, R2, C2>::Zero(b.rows(), b.cols()));
  Eigen::Matrix<T, R2, C2> deriv_b(Eigen::Matrix<T, R2, C2>::Zero(b.rows(), b.cols()));
  ...
  Eigen::Matrix<T, R1, C2> deriv_A_mult_inv_b = mdivide_right(deriv_A, val_b);
  Eigen::Matrix<T, R2, C2> deriv_b_mult_inv_b = mdivide_right(deriv_b, val_b);

  Eigen::Matrix<T, R1, C2> deriv = deriv_A_mult_inv_b - multiply(A_mult_inv_b, deriv_b_mult_inv_b);
...
inline Eigen::Matrix<fvar<T>, R1, C2> mdivide_right_tri_low(
  ...
  Eigen::Matrix<T, R1, C2> deriv = -multiply(A_mult_inv_b, deriv_b_mult_inv_b);
